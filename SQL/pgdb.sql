...
CREATE INDEX application_id_index ON gar_applications (id);
...
CREATE INDEX application_tenant_id_index ON gar_application_tenants (application_id, tenant_id);
...
CREATE INDEX group_id_index ON gar_groups (id);
...
CREATE INDEX group_role_id_index ON gar_group_roles (role_id, group_id);
...
CREATE INDEX group_user_id_index ON gar_group_users (group_id, user_id);
...
CREATE INDEX permission_id_index ON gar_permissions (id);
...
CREATE INDEX resource_id_index ON gar_resources (id);
...
CREATE INDEX resource_dynamic_props_id_index ON gar_resource_dynamic_props (id);
...
CREATE INDEX role_id_index ON gar_roles (id);
...
CREATE INDEX role_permission_id_index ON gar_role_permissions (role_id, permission_id);
...
CREATE INDEX router_group_id_index ON gar_router_group (id);
...
CREATE INDEX system_config_id_index ON gar_system_config (id);
...
CREATE INDEX tenant_id_index ON gar_tenants (id);
...
CREATE INDEX token_id_index ON gar_tokens (id);
...
CREATE INDEX user_id_index ON gar_users (id);
...
CREATE INDEX user_credential_id_index ON gar_user_credentials (id);
...
CREATE INDEX user_tenant_id_index ON gar_user_tenants (id);
...
CREATE INDEX user_tenant_application_id_index ON gar_user_tenant_applications (user_id, tenant_id, application_id);
...
CREATE INDEX log_id_index ON gar_logs (id);
...
INSERT INTO gar_user_credentials(id, created_time, modified_time, credential, expired_date_time, user_id) VALUES ('1', '1522252800000', '1522252800000', '21232f297a57a5a743894a0e4a801fc3', '7959830400000', '1');
...
INSERT INTO gar_role_permissions(role_id, permission_id, id) VALUES ('2', '9', '85');
...
INSERT INTO gar_role_permissions(role_id, permission_id, id) VALUES ('3', '1', '95');
